...
%for l=1:5
    ...
    if l==1
        ...
        g_hat = recover_from_samples_old(p(w), y, gamma, M, Vk, Dk);     
    else        
%         opts=[];
...
gamma = .01;
g_hat = recover_from_samples_old(p(w), y, gamma, M, Uk, Dk);     
% g = Uk*g_hat;
...
g = Uk*g_hat;
y = f(w_orig,:);
g2_hat = recover_from_samples_old(p(w_orig), y, gamma, M_orig, Uk, Dk);     
g2 = Uk*g2_hat;
